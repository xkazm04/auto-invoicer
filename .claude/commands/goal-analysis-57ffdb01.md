# Fix contrast, readability, and merge ThemeSwitcher into AppHeader

## Goal
Three problems: (1) ThemeSwitcher overlaps AppHeader � merge theme toggle into the header bar. (2) Both themes have undersized typography and muted/gray colors with poor readability against backgrounds. (3) Systematic pass: scan every component for contrast issues, fix each one. Goal is readable, accessible text across the entire app.
