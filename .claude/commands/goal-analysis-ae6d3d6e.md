# Complete VAT/ARES integration: full legal data, styled lookup, reusable PartySection

## Goal
[AUTONOMOUS - Phase 2a, fixes Run #8 gaps] (1) Extend ARES response to capture ico, dic, pravniForma, textovaAdresa � all legally required on CZ invoices. (2) Style lookup buttons as proper themed action buttons. (3) Extract PartySection into a reusable component with built-in VAT lookup � used by both InvoiceForm and contacts page. (4) Wire lookup into contacts page. (5) Extend Party/Contact types with registrationId field for ICO.
