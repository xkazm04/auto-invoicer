# Use Template � pre-fill invoices from saved recurring templates

## Goal
Wire the existing recurring templates store into the invoice creation flow. Template picker in InvoicesModule, pre-fill from template data (contact, line items, payment, currency, VAT), update lastUsedAt. Also add Use button in Settings template list.
