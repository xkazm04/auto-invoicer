# Client contact book with reuse across invoices

## Goal
[AUTONOMOUS - Phase 2a] Save supplier/customer profiles to a localStorage contact book. Select from saved contacts when creating invoices to auto-fill party fields. Source: web research (every competitor has this) + vision doc Contacts/CRM section. Builds on existing Party type + localStorage drafts patterns.
