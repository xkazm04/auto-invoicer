# PDF export of InvoiceForm

## Goal
Add a Download PDF button to the InvoiceForm that produces a styled PDF of the current invoice. Ship as a vertical slice: PDF generation utility, API route or client-side trigger, and a button wired into InvoiceForm. Theme-aware if feasible.
