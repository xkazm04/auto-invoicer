...
Analyze the **auto-invoicer** codebase at **C:\Users\mkdol\dolla\auto-invoicer** and create/update intelligent, structure-based contexts in the SQLite database.

## Project Information

- **Project ID**: c6c4ca82-80f1-4cb5-bbed-25d38c40505d
- **Project Name**: auto-invoicer
- **Project Path**: C:\Users\mkdol\dolla\auto-invoicer
- **Project Type**: nextjs
- **Scan Timestamp**: 2026-04-08T21-43-58
...
- `PROJECT_ID` → c6c4ca82-80f1-4cb5-bbed-25d38c40505d
- `PROJECT_PATH` → C:\Users\mkdol\dolla\auto-invoicer
...
```bash
curl -X GET "http://localhost:3000/api/contexts?projectId=c6c4ca82-80f1-4cb5-bbed-25d38c40505d"
```
...
find "C:\Users\mkdol\dolla\auto-invoicer/src/app" -maxdepth 1 -type d -name "*-page" 2>/dev/null
find "C:\Users\mkdol\dolla\auto-invoicer/src/app/features" -maxdepth 1 -type d -name "sub_*" 2>/dev/null
```

### 3. Read High-Level Architecture (Optional)

```bash
cat "C:\Users\mkdol\dolla\auto-invoicer/context/high.md" 2>/dev/null || echo "No high-level architecture file found"
```
...
mkdir -p "C:\Users\mkdol\dolla\auto-invoicer/docs/contexts"

# Generate the report
cat > "C:\Users\mkdol\dolla\auto-invoicer/docs/contexts/scan-report-2026-04-08T21-43-58.md" << 'EOF'
# Context Scan Report

**Date**: 2026-04-08T21-43-58
**Project**: auto-invoicer
**Project ID**: c6c4ca82-80f1-4cb5-bbed-25d38c40505d
...
C:\Users\mkdol\dolla\auto-invoicer/docs/contexts/scan-report-2026-04-08T21-43-58.md
