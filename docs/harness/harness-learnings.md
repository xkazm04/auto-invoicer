...
- No test infrastructure (vitest not configured; quality score capped at 70/100 because of this).
- "Create Invoice" currently shows `alert()` on success — needs a real submission flow or at minimum a styled success state.
